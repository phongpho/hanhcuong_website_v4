...
<head>
    ...
    <title><?= $lang['page_title_cow'] ?></title>
...
<body>
    ...
    <section class="section first-sec">
        <div class="container" id="flexiable" >
            <div class="content-side">
                <h2><?= $lang['cow_detail_title'] ?></h2>
                <p><?= $lang['cow_detail_p1'] ?></p>
                <p><?= $lang['cow_detail_p2'] ?></p>
            </div>
            <div class="img-side">
    ...
    <section class="section">
        <div class="container">
            <div class="content-side">
                <h2><?= $lang['cow_breeds_title'] ?></h2>
            </div>
            <div class="content-grid">
                <div class="livestock-item">
                    <img class="livestock-img" src="assets/images/bo-thit.png" alt="<?= $lang['cow_meat'] ?>">
                    <div class="livestock-content">
                        <h3><?= $lang['cow_meat'] ?></h3>
                        <p><?= $lang['cow_meat_desc'] ?></p>
                    </div>
                </div>
                <div class="livestock-item">
                    <img class="livestock-img" src="assets/images/bo-sua.png" alt="<?= $lang['cow_dairy'] ?>">
                    <div class="livestock-content">
                        <h3><?= $lang['cow_dairy'] ?></h3>
                        <p><?= $lang['cow_dairy_desc'] ?></p>
                    </div>
                </div>
            </div>
        </div>
