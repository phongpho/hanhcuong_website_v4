...
<head>
    ...
    <title><?= $lang['page_title_goat'] ?></title>
    <link
...
<body>
    ...
    <section class="section first-sec">
        <div class="container" id="flexiable">
            <div class="content-side">
                <h2><?= $lang['goat_detail_title'] ?></h2>
                <p><?= $lang['goat_detail_p1'] ?></p>
                <p><?= $lang['goat_detail_p2'] ?></p>
                <p><?= $lang['goat_detail_p3'] ?></p>
            </div>
            <div class="img-side">
    ...
    <section class="section">
        <div class="container">
            <div class="content-side">
                <h2><?= $lang['goat_breeds_title'] ?></h2>
            </div>
            <div class="content-grid">
                <div class="livestock-item">
                    <img class="livestock-img" src="assets/images/de-thit.png" alt="<?= $lang['goat_meat'] ?>">
                    <div class="livestock-content">
                        <h3><?= $lang['goat_meat'] ?></h3>
                        <p><?= $lang['updating'] ?></p>
                    </div>
                </div>
                <div class="livestock-item">
                    <img class="livestock-img" src="assets/images/de-thit.png" alt="<?= $lang['goat_type'] ?>">
                    <div class="livestock-content">
                        <h3><?= $lang['goat_type'] ?></h3>
                        <p><?= $lang['updating'] ?></p>
                    </div>
                </div>
            </div>
