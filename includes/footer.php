    ...
    <div class="container-footer">
        <div class="footer-grid">
            ...
            <div class="footer-col footer-logo-col">
                <img src="assets/images/logo.png" class="footer-logo-img" alt="Logo Hạnh Cường">
            </div>

            <div class="footer-col footer-info-col">
                <p class="company-name"><?= $lang['company_name_prefix'] ?></p>
                <h2 class="name-strong">HẠNH CƯỜNG</h2>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-contact">
                    <li>
                        <svg width="18" height="18" fill="none" stroke="var(--color-secondary)" stroke-width="2"
                            viewBox="0 0 24 24">
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="#"><?= $lang['business_areas'] ?></a></li>
